...
export default function FacilitiesContent() {
  ...
  const ColorMap: Record<StatusColor, string> = {
    [STATUS_COLORS.GREEN]: 'text-green-600',
    [STATUS_COLORS.YELLOW]: 'text-yellow-600',
    [STATUS_COLORS.RED]: 'text-red-600',
    [STATUS_COLORS.GRAY]: 'text-gray-400',
  };
  ...
  return (
    <div className="flex flex-col h-screen bg-white overflow-hidden">
      ...
      {/* ───── Table with integrated date filter ───── */}
          ...
          <table className="w-full text-sm">
            ...
            <thead className="bg-gray-100 border-b">
              <tr>
                ...
                {units.map(u => (
                  <th key={u.id} className="px-2 py-3 text-center">
                    <button
                ...
                <th className="px-4 py-3 text-center text-xs text-gray-500">Supervised By</th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      <Avatar className="h-8 w-8 mx-auto">
                        <AvatarFallback className="text-xs bg-gray-100">PA</AvatarFallback>
                      </Avatar>
                    </td>
                  </tr>
                );
